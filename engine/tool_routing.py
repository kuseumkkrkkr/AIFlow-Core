...
ROUTE_SPECS = (
    ...
    RouteSpec("hs_ascii_power_product", "유리수 지수 두 항의 곱", ("^(", "1/2", "1/3", "지수법칙")),
    RouteSpec("hs1_trigonometry", "특수각 삼각함수", ("삼각함수", "sin", "cos", "tan", "사인", "코사인")),
    RouteSpec("hs2_limit", "다항식 극한", ("극한", "lim", "->")),
    RouteSpec("hs_polynomial_difference_quotient", "일반 다항식 차분몫 미분계수", ("lim", "f(1+h)", "f(a+h)", "/h")),
    RouteSpec("hs_linear_sigma_identity", "합 기호 선형식의 수열 합", ("sum_", "a_k", "Σ", "수열")),
    RouteSpec("hs_piecewise_continuity", "조각함수 경계점 연속 조건", ("for x<", "for x>=", "continuity", "연속")),
